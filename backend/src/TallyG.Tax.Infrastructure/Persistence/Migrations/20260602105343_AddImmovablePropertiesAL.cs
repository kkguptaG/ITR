...
{
    /// <inheritdoc />
    public partial class AddImmovablePropertiesAL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "immovable_properties_al",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_immovable_properties_al", x => x.id);
                    table.ForeignKey(
                        name: "fk_immovable_properties_al_tax_returns_tax_return_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_immovable_properties_al_tax_return_id",
                table: "immovable_properties_al",
